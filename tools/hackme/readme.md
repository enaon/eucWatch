...
Select 816 and sc7a20 for the touch and accelerometer if not sure, they can be later re-selected by uploading just the handler file. The timezone is not importand. 
