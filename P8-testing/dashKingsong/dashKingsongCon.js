...
face[0] = {
	...
	init: function(){
		...
		this.btn(euc.dash.ks.aOff,"VOICE",22,185,15,7,1,122,0,239,97,"ENABLE",28,185,50);		
	...
	switch (e) {
      case 5: case 12: //tap event
		if ( x<=120 && y<100 ) { //auto Ride
			...
			euc.dash.ks.aMusic=1-euc.dash.ks.aMusic;
            face[0].btn(euc.dash.ks.aOff,"VOICE",22,185,15,7,1,122,0,239,97,"ENABLED",28,185,50);		
            face[0].ntfy("VOICE MODE ENABLED","NO ACTION",(euc.dash.ks.aOff)?17:19,1,euc.dash.ks.aOff);
			buzzer([30,50,30]);		
