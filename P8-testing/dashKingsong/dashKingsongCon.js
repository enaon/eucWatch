	...
	switch (e) {
      case 5: case 12: //tap event
		if ( x<=120 && y<100 ) { //light
			...
			face[0].btn(euc.dash.ks.aVoiceC,"VOICE",18,185,115,euc.dash.ks.aVoiceC==2?12:1,0,122,100,239,195,"MODE",30,185,150);	
            face[0].ntfy(euc.dash.ks.aVoiceC==2?"ENABLE VOICE MODE":"DISABLE VOICE MODE","NO ACTION",20,1,euc.dash.ks.aVoiceC);
			buzzer([30,50,30]);					
		}else buzzer(40);
		break;
