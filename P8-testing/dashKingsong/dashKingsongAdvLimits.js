...
touchHandler[0]=function(e,x,y){
        ...
        if (!face[0].setE){//select page
			...
			if (120<=x) { //up
                if (face[0].setEb=="spd") 
                    ...
                    if (euc.dash.limt.tilt<75) euc.dash.limt.tilt++;
                    else face[0].ntfy("THE LIMIT IS 75KpH","",20,7,1);
                    } 
            }else {  //dn
                if (face[0].setEb=="spd") {
					if (5<euc.dash.limt.spd) euc.dash.limt.spd--;
                }else if (face[0].setEb=="spd1"){
					if (euc.dash.limt.en.spd){
					...
					else face[0].ntfy("AL2 N LIMIT IS 10KpH","",20,7,1);
                }else if (face[0].setEb=="tilt"){
            ...
            buzzer([30,50,30]);
			face[0].btn(1,euc.dash.limt[face[0].setEb],100,126,60,12,1,60,40,180,160);
		}
		this.timeout();
		break;
   ...
   case 12: //hold event
			if (x<=120&&y<100) { //alarm 1
               // if (euc.dash.limt.en.spd1){
                if (euc.dash.limt.spd>=euc.dash.limt.spd1) 
				euc.dash.limt.spd=euc.dash.limt.spd1-1;
