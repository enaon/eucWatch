...
this.g.drawImage(require("heatshrink").decompress(atob("kEgwMAn/gA4N/+ADB/4DC8FwAbvh+HnjHh8HjAYPABYNhAYVxAY0wIYU4H4U4EYUcnkP/0Oj0f/8Ph///8Hw/4g8D4IDBgIfBg8AD4IDBvgDCj+AAYIbCgEB//+FoM//gA==")),183,9);
  ...
  if (this.t[1]!=this.min ){
    ...
    this.g.fillRect(105,55,203,150);
  ...
  let sec=(set.def.hr24)?"24":(this.t[0]<12)?"AM":"PM"
  this.g.drawString(sec,239-(this.g.stringWidth(sec)),75); //hours mode
  this.g.setFont("Vector",31);
  this.g.drawString(this.s[0]+this.s[1],203,101); //seconds
