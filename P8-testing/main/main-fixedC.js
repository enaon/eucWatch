...
face[0] = {
  ...
  show : function(){
    ...
    if (notify.ring){
	  ...
	  this.ring=0;
      var colbt=3003;
      if (this.bt==3)  colbt=1963;
      else if (this.bt==4)  colbt=143;
      else if (this.bt==2)  colbt=3935;
...
this.g.drawImage(require("heatshrink").decompress(atob("kEgwMAn/gA4N/+ADB/4DC8FwAbvh+HnjHh8HjAYPABYNhAYVxAY0wIYU4H4U4EYUcnkP/0Oj0f/8Ph///8Hw/4g8D4IDBgIfBg8AD4IDBvgDCj+AAYIbCgEB//+FoM//gA==")),183,9);
      ...
      this.batt=set.ondc;
	  if (notify.nCall)  {
        this.colf=4095;this.colb=3840;this.str=notify.nCall;this.bs="nCall";
		...
		this.colf=4095;this.colb=1453;this.str=notify.nIm;this.bs="nIm";
        this.img = require("heatshrink").decompress(atob("jEYwIPMv///wCFj///EP//w4f/4fw/8P/F+j/+jATBwP/BoICBAA4mIHZAA="));
	  }else if (notify.nInfo)  {
		this.colf=4095;this.colb=170;this.str=notify.nInfo;this.bs="nInfo";
      ...
      this.batt=set.ondc;
      this.v=w.battVoltage(1);
      if (this.batt==1) this.g.setColor(0,3935);
      else if (this.v<=20) this.g.setColor(0,3840);
      else this.g.setColor(0,170);
      this.g.fillRect(162,0,239,50);//batt
      this.g.setColor(1,1535);
  ...
  widg:function(){
	...
	if (notify.ring){
	if (this.ring!=notify.ring){
	  this.ring=notify.ring;this.g.setColor(0,0);this.g.clearRect(0,151,239,239);this.g.setColor(1,4095);
      ...
      if (notify.nCall||notify.nIm||notify.nInfo){
        ...
        if (this.nCall)  {this.msg=JSON.parse(notify.call[0]);this.cf=3840;}
	    else if (this.nIm)  {this.msg=JSON.parse(notify.im[0]);this.cf=1535;}
        else if (this.nInfo)  {this.msg=JSON.parse(notify.info[0]);this.cf=1963;}
	    this.g.setColor(1,4095);//
...
//		this.g.setColor(1,1963);
  ...
  if (this.t[1]!=this.min ){
    ...
    this.fsec=0;
	if (global.alrm) {
    if (alrm.buzz!=-1) {this.bmin=2730;this.fmin=4080;this.fsec=2730;this.bsec=4080;}
    else if (alrm[1].tmr!==-1||alrm[2].tmr!==-1||alrm[3].tmr!==-1) {this.bmin=1453;this.bsec=1453;}
    else  {this.bmin=1963;this.fsec=1365;this.bsec=1963;}
	}else {this.bmin=1963;this.fsec=1365;this.bsec=1963;}
