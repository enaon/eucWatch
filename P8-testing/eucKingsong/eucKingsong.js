...
euc.cmd=function(no){
	switch (no) {
		...
		case "lock1":euc.dash.lock=1;return [0xAA,0x55,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x5d,0x14,0x5A,0x5A]; 
		case "lock":euc.dash.lock=1;return [0xAA,0x55,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x81,0x14,0x5A,0x5A]; 
		
		//aa55 01 00000000000000000000000000 81 14 5a 5a
		//aa55 01 00000000000000000000000000 5d 14 5a 5a
		...
		//case "unlock":euc.dash.lock=0;return [0xAA,0x55,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x32,0x34,0x33,0x32,0x32,0x36,0x5d,0x14,0x5A,0x5A];
		case "unlock":euc.dash.lock=0;return [0xAA,0x55,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x37,0x32,0x34,0x30,0x38,0x35,0x5D,0x14,0x5A,0x5A];
		case "unlock1":euc.dash.lock=0;return [0xAA,0x55,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x31,0x35,0x36,0x38,0x32,0x32,0x5d,0x14,0x5A,0x5A];
		case "unlock2":euc.dash.lock=0;return [0xAA,0x55,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x39,0x38,0x32,0x39,0x34,0x36,0x57,0x14,0x5A,0x5A];
		case "unlock3":euc.dash.lock=0;return [0xAA,0x55,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x39,0x30,0x34,0x31,0x33,0x39,0x5d,0x14,0x5A,0x5A];
		case "unlock4":euc.dash.lock=0;return [0xAA,0x55,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x38,0x37,0x35,0x34,0x36,0x37,0x47,0x14,0x5A,0x5A]; //ok for s18 old
		//   aa550000000000000000 37 32 34 30 38 35 5d 14 5a 5a //ok
		//   aa550000000000000000 31 35 36 38 32 32 5d 14 5a 5a
		//   aa550000000000000000 39 38 32 39 34 36 47 14 5a 5a
        //   aa550000000000000000 34 39 34 39 33 37 47 14 5a 5a
		//case "unlock":euc.dash.lock=0;return [0xAA,0x55,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x38,0x37,0x35,0x34,0x36,0x37,0x47,0x14,0x5A,0x5A];
