//code by freestyl3r
//modified for v12 - currently not working are stats and most of the setting commands including lights/horn
/*
	//info type:
	NoOp(0),
	Version=1,
	...
	NRF.connect(mac,{minInterval:7.5, maxInterval:15})
		.then(function(g) {
			...
			euc.rCha.on('characteristicvaluechanged', function(event) {
				...
				//batt
				euc.dash.bat=Math.round(100*(euc.dash.volt*4.16 - euc.dash.batE ) / (euc.dash.batF-euc.dash.batE) );
				...
				//temp - mosfet temp
				euc.dash.tmp=(event.target.value.buffer[45] & 0xff) + 80 - 256;
				...
				//alarm
				euc.dash.alrm=event.target.value.buffer[64];
				//log
