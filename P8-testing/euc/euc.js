...
//		return emuS([ 32, 20, 62, 4, 176, 0, 0, 0, 0, 72, 152, 0, 0, euc.dash.bat, 0, "0x"+(euc.dash.spd*100+0x10000).toString(16).substr(3), parseInt(d2h(euc.dash.spd*100).substr(0,2),16), 0, 0, 24, 56, 37, 0, 0, 0, 59, 0,euc.dash.tmp,0,parseInt((euc.dash.volt*100).toString(16).substr(2),16), parseInt((euc.dash.volt*100).toString(16).substr(0,2),16), euc.dash.amp, 0, 0, 0, 0, 0]);
...
//		return emuS([0x0e,0x14,0x3e,0x04,0x10,0x4e,0x33,0x4f,0x54,0x43,0x31,0x38,0x33,0x33,0x54,0x30,0x30,0x30,0x30]);  
	...
	case "Z\xA5\1>\x11\1\x40\x1e\x50\xFF": 
		//return;
//		return emuS([0x1e,0x11,0x3e,0x04,0x40,0xa2,0x0e,0xae,0xeb,0x8d,0x8c,0xdc,0x58,0x86,0x34,0xe3,0xf8,0xbd]);  
