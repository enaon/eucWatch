...
euc.cmd=function(no){
	switch (no) {
		...
		case "strobeStart":return [0xAA,0x55,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x53,0x14,0x5A,0x5A];
		case "strobeStop":return [0xAA,0x55,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x53,0x14,0x5A,0x5A];
		case "off":return [0xAA,0x55,0x00,0xE0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x40,0x14,0x5A,0x5A];
		case "pass": return [0xAA,0x55,0x30+Number(euc.dash.pass.toString()[0]),0x30+Number(euc.dash.pass.toString()[1]),0x30+Number(euc.dash.pass.toString()[2]),0x30+Number(euc.dash.pass.toString()[3]),0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x44,0x14,0x5A,0x5A]; 
...
return  c;
	...
	if (euc.dash.passSend&&euc.dash.pass) setTimeout(function(){c.writeValue(euc.cmd("pass"));},500);
