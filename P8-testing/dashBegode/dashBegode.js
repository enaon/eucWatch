...
face[0] = {
	...
	init: function(){
		...
		this.btn("WATCH",22,185,17,(euc.dash.hapS||euc.dash.hapA||euc.dash.hapT||euc.dash.hapB)?1453:1365,122,0,239,97,"ALERTS",22,185,55);//2
        this.btn("TPMS",25,60,137,1365,0,100,119,195,"",22,60,155); //3
