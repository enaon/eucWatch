...
function bcon() {
	...
	set.bt=1; 
	if (set.def.cli||set.def.gb||set.def.emuZ) { 
...
function bdis() {
	...
	else if (set.bt==4) {euc.proxy.F=0;handleInfoEvent({"src":"BT","title":"EUC-PROXY","body":"Disconnected"});}
