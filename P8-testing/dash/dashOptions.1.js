...
face[0] = {
	...
	init: function(){
		...
		this.g.flip(); 
		this.btn(1,(ew.def.dash.mph)?"MPH":"KPH",30,40,25,1,0,0,0,75,75);//1
		this.btn(1,"o",20,100,20,1,0,80,0,155,75,(ew.def.dash.farn)?"F":"C",30,120,25);//2
		//let makr=ew.do.fileRead("dash","slot"+ew.do.fileRead("dash","slot")+"Maker"); 
		//if (makr) {
			//if (makr=="Begode"){
		this.btn(1,"CON",27,200,30,4,0,160,0,239,75,"",30,200,35); //3
		...
		this.btn(1,"RETRY",15,40,90,1,0,0,80,75,155,ew.def.dash.rtr,30,40,120); //4
		//this.btn(1,"DIST X",15,120,90,1,0,80,80,155,155,euc.dash.opt.unit.fact.dist,30,120,120); //5
		this.btn(1,"HA",27,120,110,4,0,80,80,155,155,"",30,120,120); //5
		//this.btn(1,"RETRY",15,200,90,1,0,160,80,239,155,ew.def.dash.rtr,30,200,120); //6
		this.btn(1,"DIS",27,200,110,4,0,160,80,239,155,"",30,200,120); //6
