...
face[0] = { 
  ...
  init: function(o){ 
	...
	this.slot4Mac=require("Storage").readJSON("dash.json",1).slot4Mac;
	this.slot1Maker=require("Storage").readJSON("dash.json",1).slot1Maker;
	this.slot2Maker=require("Storage").readJSON("dash.json",1).slot2Maker;
	this.slot3Maker=require("Storage").readJSON("dash.json",1).slot3Maker;
	this.slot4Maker=require("Storage").readJSON("dash.json",1).slot4Maker;
...
//	          t.g.drawString("EMPTY",60-(t.g.stringWidth("EMPTY")/2),40);
    ...
    if (this.s2!=this.sv2){
		...
		if (this.slot2Mac) {
			...
			this.g.setFont("Vector",13);	
			this.g.drawString(this.slot2Mac.substring(0,17),185-(this.g.stringWidth(this.slot2Mac.substring(0,17))/2),78); 
			this.g.setFont("Vector",30);	
...
//	          t.g.drawString("EMPTY",185-(t.g.stringWidth("EMPTY")/2),40);
    ...
    if (this.s3!=this.sv3){
	    ...
	    if (this.slot3Mac) {
			...
			this.g.setFont("Vector",13);	
			this.g.drawString(this.slot3Mac.substring(0,17),60-(this.g.stringWidth(this.slot3Mac.substring(0,17))/2),178); 
			this.g.setFont("Vector",30);	
...
//	          t.g.drawString("EMPTY",60-(t.g.stringWidth("EMPTY")/2),140);
    ...
    this.g.fillRect(122,100,239,195);
			...
			this.g.setFont("Vector",13);	
			this.g.drawString(this.slot4Mac.substring(0,17),185-(this.g.stringWidth(this.slot4Mac.substring(0,17))/2),178); 
			this.g.setFont("Vector",30);	
