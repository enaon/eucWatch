...
face[0]= {
  ...
  init: function(){
    ...
    this.g.setColor(0);//header bck
    this.g.fillRect(0,0,239,38); 
    this.g.setColor(14);//header txt
  ...
  show : function(){
    ...
    if (alrm[1].tmr!=this.al1) {
      this.al1=alrm[1].tmr;
      this.c=15;
      if (this.al1!==-1) this.g.setColor(4);
      else { this.g.setColor(2); this.c=0;}
    ...
    if (alrm[2].tmr!=this.al2) {
      this.al2=alrm[2].tmr;
	  this.c=15;
      if (this.al2!==-1) this.g.setColor(4);
      else { this.g.setColor(2); this.c=0;}
    ...
    if (alrm[3].tmr!=this.al3) {
      this.al3=alrm[3].tmr;
      this.c=15;
      if (this.al3!==-1) this.g.setColor(4);
      else { this.g.setColor(2); this.c=0;}
...
face[5] = {
  ...
  show : function(o){
    ...
    if (alrm[o].hour!=this.al[o].hour) {
		...
		if (alrm[o].tmr!=-1) this.g.setColor(14);else this.g.setColor(15);
    ...
    if (alrm[o].snz!=this.al[o].snz) {
		...
		this.c=0;
		if (this.al[o].snz===1)  { this.g.setColor(4);this.c=15;}
		else this.g.setColor(2); 
    ...
    if (alrm[o].rep!=this.al[o].rep) {
		...
		this.c=0;
		if (this.al[o].rep===1) { this.g.setColor(4);this.c=15;}
		else this.g.setColor(2); 
...
//face.go("alarm",-1);return;
	  ...
	  if(39<y&&y<105) {
		if(alrm[1].on===1) {alrm.stop(1);face[0].al1=-2;}
		else {buzzer(ew.pin.BUZZ,0,[90]);face.go("alarm",5,1);return; }
        buzzer(ew.pin.BUZZ,0,[30,50,30]);
	  }else if(105<y&&y<174) {
		if(alrm[2].on===1) {alrm.stop(2);face[0].al2=-2;}
		else {buzzer(ew.pin.BUZZ,0,[90]);face.go("alarm",5,2);return;}
        buzzer(ew.pin.BUZZ,0,[30,50,30]);
      }else if(174<y&&y<239) {
		if(alrm[3].on===1) {alrm.stop(3);face[0].al3=-2;}
		else {buzzer(ew.pin.BUZZ,0,[90]);face.go("alarm",5,3);return;}
        buzzer(ew.pin.BUZZ,0,[30,50,30]);
	  }else buzzer(ew.pin.BUZZ,0,40);    
    }
    face.off();
