...
face[0] = {
    ...
    ntfy: function(txt0,txt1,size,bt,clr,tm,s){
			...
			this.ntid=setTimeout(function(t){
				...
				t.set=0;
				if (!t.page){
					t.btn(1,"EMPTY",15,200,10,1,0,160,0,239,75,euc.dash.batE/100,30,200,35); //3
				...
				t.g.setColor((t.page)?2:15);
				t.g.fillRect(75,180,120,184);
				t.g.flip();
				t.g.setColor((t.page)?15:2);
...
touchHandler[0]=function(e,x,y){ 
			...
			if (y < 155) {
				...
				if (face[0].set=="spdF") { 
				  ...
				  if (x<120){ //
					...
					face[0].btn(1,"EMPTY",15,200,10,12,0,160,0,239,75,euc.dash.batE/100,30,200,35); //3
	...
	case 3: //slide left event
		...
		if (!face[0].page) {
			face[0].page=1;
			face[0].btn(1,"",30,40,25,1,0,0,0,75,75);//1
			...
			face[0].btn(1,"",15,40,90,1,0,0,80,75,155,"",30,40,120); //4
