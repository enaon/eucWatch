...
face[0] = {
	...
	init: function(){
		...
		if (!this.b1) {
			this.b1t="HARD";this.b1c=6;
		}else if (this.b1==1) {
			this.b1t="MED";this.b1c=6;
		}else if (this.b1==2) {
			this.b1t="SOFT";this.b1c=5;
		}
		this.g.setColor(this.b1c);
	...
	switch (e) {
      case 5:case 12: //tap event
		if ( x<=120 && y<=100 ) { //ride mode
			...
			else if (euc.dash.mode==1) {euc.dash.mode=2;euc.wri("rideSoft");face[0].btn("MODE",18,60,15,5,0,0,119,97,"SOFT",30,60,50);}
			else if (euc.dash.mode==2) {euc.dash.mode=0;euc.wri("rideHard");face[0].btn("MODE",18,60,15,6,0,0,119,97,"HARD",30,60,50);}
