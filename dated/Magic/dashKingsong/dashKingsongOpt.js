	...
	switch (e) {
      case 5: //tap event
		if ( x<=120 && y<100 ) { //ride led
            ...
            face[0].ntfy("RIDE LED ON","RIDE LED OFF",18,1,euc.dash.lght.ride);
            ...
            face[0].ntfy("LIFT SENSOR ENABLED","LIFT SENSOR DISABLED",16,1,euc.dash.ks.lift);
            ...
            face[0].ntfy("BUTTON IS HORN >2KPH","HORN DISABLED",18,1,euc.dash.horn);
			buzzer(ew.pin.BUZZ,0,[30,50,30]);						
