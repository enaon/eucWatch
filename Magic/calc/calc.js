...
//side   
    ...
    if (this.disp!=calc.disp){
      ...
      if (calc.disp==""){
        if (calc.val!=""){
          ...
          }else {this.out="-"; this.g.setColor(15);}
        }else if (calc.sum!=""){
          this.g.setColor(14);
          this.out=this.comf(Number(calc.sum));
        }else {this.g.setColor(2);this.out=0;}
      }else {this.g.setColor(15);
        this.out=calc.disp;
  ...
  math:function(s){
    ...
    if (calc.disp!="") {
      if(calc.disp.substring(calc.disp.length-1)==".") {buzzer(ew.pin.BUZZ,0,40);return;}
      if(calc.disp.substring(calc.disp.length-1)=="-") {buzzer(ew.pin.BUZZ,0,40);return;}
      ...
      else {buzzer(ew.pin.BUZZ,0,40);return;}
