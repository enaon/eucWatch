...
face[0] = {
	...
	buzF: function(){
		...
		this.g.setColor((this.buzz)?7:1);
		this.g.fillRect(0,115,40,173); 
		this.g.setColor((this.buzz)?15:0);
	...
	spLF: function(){
		...
		this.g.setColor((euc.dash.lim[3]<=this.spdL)?1:7);	
	...
	amLF: function(){
		"ram";
		this.ampL.set(ampL);
		this.g.setColor((1<euc.dash.ampC)?7:1);
		this.g.fillRect(0,0,119,50);       
		this.g.setColor(15);
	...
	pwrF: function(){
		...
		this.g.setColor((50<=euc.dash.pwr)?(80<=euc.dash.pwr)?7:13:15);
...
face.dash_digital={"0":face[0],"1":face[1]};
...
touchHandler.dash_digital={"0":touchHandler[0]};
