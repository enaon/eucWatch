...
E.kickWatchdog();
if (process.env.BOARD == "PINETIME") D15.write(1);
function KickWd() {
  "ram";
...
if (process.env.BOARD == "PINETIME")
  global.ew = {"dbg":0, "log":[], "def": {}, "is": {}, "do": { "reset": {}, "update": {} }, "tid": {}, "temp": {}, "pin": { BAT: D31, CHRG: D19, BUZZ: D16, BUZ0: 1, BL: D12, i2c: { SCL: D7, SDA: D6 }, touch: { RST: D10, INT: D28 }, disp: { CS: D25, DC: D18, RST: D26, BL: D14 }, acc: { INT: D8 } } };
else
