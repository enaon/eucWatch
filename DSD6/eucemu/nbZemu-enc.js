...
//		Bluetooth.write([0x5a,0xa5,0x0e,0x14,0x3e,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x9b,0xff]);
	...
	else if  (l=="Z\xA5\1>\x11\1\x3b\x02\x71\xFE"){ //unknown
		lolo= new Uint8Array([0x5a,0xa5,0x02,0x11,0x3e,0x04,0x3b,0x62,0x00])  ;
		send(lolo);
		print("unk10");
	}
	else if  (l=="Z\xA5\1>\x11\1\x20\x02\x8c\xFE"){ //unknown
		lolo= new Uint8Array([0x5a,0xa5,0x02,0x11,0x3e,0x04,0x20,0x01,0x25]) ; 
		send(lolo);
		print("unk11");
	}
	else if  (l=="Z\xA5\1>\x12\1\x10\x1a\x83\xFE"){ //unknown
	...
	else if  (l=="Z\xA5\1>\x12\1\x3b\x02\x70\xFE"){ //unknown
		lolo= new Uint8Array([0x5a,0xa5,0x02,0x12,0x3e,0x04,0x3b,0x62,0x00])  ;
		send(lolo);
		print("unk13");
	}
	else if  (l=="Z\xA5\1>\x12\1\x20\x02\x8b\xFE"){ //unknown
		lolo= new Uint8Array([0x5a,0xa5,0x02,0x12,0x3e,0x04,0x20,0x01,0x25]) ; 
		send(lolo);
		print("unk14");
	}
	else if  (l=="Z\xA5\1>\x14\1\xb0\x20\xdb\xFE"){ //live1
	...
	else if  (l=="Z\xA5\1>\x11\1\x30\x0e\x70\xFE"){ //unknown
	...
	else if  (l=="Z\xA5\1>\x11\1\x40\x1e\x50\xFE"){ //unknown
		lolo= new Uint8Array([0x5a,0xa5,0x1e,0x11,0x3e,0x04,0x40,0xa2,0x0e,0xae,0xeb,0x8d,0x8c,0xdc,0x58,0x86,0x34,0xe3,0xf8,0xbd,0x0e,0xba,0x0e,0xbd,0x0e,0xb5,0xeb,0x92,0x8c,0xc2,0x58,0xe1,0x34,0x95,0xf8,0x00,0x00]) ; 
		send(lolo);
		print("unk22");
	}
	else if  (l=="Z\xA5\1>\x12\1\x30\x0e\x6f\xFE"){ //unknown
	...
	else if  (l=="Z\xA5\1>\x12\1\x40\x1e\x4f\xFE"){ //unknown
		...
		print(4,"rest",E.toString(line),Bluetooth.read());
		la=1;
		Bluetooth.write([0x5a,0xa5,0x20,0x14,0x3e,0x04,0xb0,0x00,0x00,0x08,0xe5,0x62,0x1a,0x7b,0x56,0x1e,0x3a,0x54,0xf6,0xc2,0x03,0x82,0x82,0x29,0x00,0x08,0xe5,0x03,0x82,0x09,0x57,0x5c,0x2e,0x51,0xf6,0x00,0x00,0xc2,0x03,0xd3,0xf9]);
    }
}
