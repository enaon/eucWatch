...
>**Notice**:
>There are two problems is one problem one might face when buying a P8 watch to use with this git. 
>1. The p8 line is changing the CPU used, there is a model called GAM that no longer uses the NRF. P22B is a valid replacement. 
