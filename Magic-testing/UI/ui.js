UI={
  ...
  pos:{
	...
	_main:[20,[0,20,80,180],[81,20,160,180],[161,20,239,180],[0,20,160,180],[81,20,239,180],[0,20,239,180],[0,20,239,100],[0,101,239,180],[0,81,239,180]],
	_top:20,
	_head:2,
	_foot:255,
  },
  btn:{
	...
	ntfy:function(rst,tmot,ignr,no,po,txt1,txt2,fclr,bclr,sel){
		...
		if (!ignr){
			...
			if (txt2) 	w.gfx.drawString(txt2,x-(w.gfx.stringWidth(txt2)/2),p[3]-w.gfx.stringMetrics(txt2).height-10);
			if (sel) {
