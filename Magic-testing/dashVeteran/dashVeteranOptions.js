	...
	case 5: //tap event
		if (face[0].set) { 
			...
			if ( x<=120 && y<100 ) { 
				...
				face[0].btn(dash.live.lock,"BEEP",28,60,35,4,1,0,0,119,97);
				face[0].ntfy("BEEP ON CON/DIS","NO BEEP",22,(dash.live.lock)?4:1,dash.live.lock);
				buzzer(buz.ok);
			}else if ( 120<=x && y<=100 ) { //
				buzzer(buz.na);	
				...
				face[0].btn(dash.live.horn,"HORN",25,185,135,4,1,122,100,239,195);
