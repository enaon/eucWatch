...
face[0] = { 
	...
	bar : function(){
		...
		UIc.get=1;UIc.cord="";
		this.dash.slot1Mac?UI.btn.c2l("_2x2",1,this.dash.slot1Maker.toUpperCase(),this.dash.slot1Name.toUpperCase(),this.dash.slot==1?14:0,this.dash.slot==1?4:3):UI.btn.c2l("_2x2",1,"","",0,0);
		this.dash.slot2Mac?UI.btn.c2l("_2x2",2,this.dash.slot2Maker.toUpperCase(),this.dash.slot2Name.toUpperCase(),this.dash.slot==2?14:0,this.dash.slot==2?4:3):UI.btn.c2l("_2x2",2,"","",0,0);
		this.dash.slot3Mac?UI.btn.c2l("_2x2",3,this.dash.slot3Maker.toUpperCase(),this.dash.slot3Name.toUpperCase(),this.dash.slot==3?14:0,this.dash.slot=3?4:3):UI.btn.c2l("_2x2",3,"","",0,0); 
		this.dash.slot4Mac?UI.btn.c2l("_2x2",4,this.dash.slot4Maker.toUpperCase(),this.dash.slot4Name.toUpperCase(),this.dash.slot==4?14:0,this.dash.slot==4?4:3):UI.btn.c2l("_2x2",4,"","",0,0);
